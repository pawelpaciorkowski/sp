...
export function FilesSpecialStageComponent({
    ...
    const saveCollection = useCallback(
        (collectionKey: string, collection: any) => {
            setCollectedFormData((prevCollectedData) => ({
                ...prevCollectedData,
    ...
    return (
        <>
            {stage.fields.map((field) =>
                <MatchFields field={field} changeEvent={handleChange} saveCollection={saveCollection}/>
            )}
            <button
