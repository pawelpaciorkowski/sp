...
export default function CollectionPointsCollectionField({field, disabled, saveCollection}: any){
    ...
    return (<>
            {field.template.map((_field: any) => {
                return <SelectComponent disabled={disabled} formData={formData} setFormData={setFormData} flowSavedData={flowData} _field={_field} parentField={field}/>
            })}
            {!disabled && <button
