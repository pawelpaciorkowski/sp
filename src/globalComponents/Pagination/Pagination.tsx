...
const Pagination: React.FC<PaginationProps> = ({ totalItems, itemsPerPage, currentPage, onPageChange }) => {
    ...
    return (
      <div className="flex justify-end mr-4 mb-2">
        {currentPage !== 1 && (
          <button className='mr-1 bg-gradient-to-r from-blue-400 to-blue-500 text-white px-2 py-1 text-sm rounded shadow-lg hover:shadow-xl transition-shadow duration-300' onClick={() => onPageChange(currentPage - 1)}><ChevronDoubleLeft size={12} /></button>
        )}
